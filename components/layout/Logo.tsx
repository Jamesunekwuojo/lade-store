...
export function Logo({
  ...
  const sizeConfig = {
    ...
    md: {
      ...
      textClass: "text-base sm:text-lg md:text-xl tracking-[0.18em] sm:tracking-[0.24em]",
    },
    lg: {
      width: 44,
      height: 60,
      imgClass: "h-10 sm:h-11 md:h-12 w-auto",
      textClass: "text-lg sm:text-xl md:text-2xl tracking-[0.2em] sm:tracking-[0.26em]",
    },
  }[size];
